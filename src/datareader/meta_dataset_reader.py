...
from datareader.paths import META_DATASET_ROOT, META_RECORDS_ROOT, PROJECT_ROOT
sys.path.append(os.path.abspath(META_DATASET_ROOT))
from meta_dataset.data import dataset_spec as dataset_spec_lib
from meta_dataset.data import learning_spec
from datareader import pipeline
...
class MetaDatasetReader:
    ...
    """
    def __init__(self, data_path, mode, train_set, validation_set, test_set, max_way_train, max_way_test, max_support_train, max_support_test, image_size=84, shuffle=False):
        ...
        self.test_set_dict = {}
        print('tf_record path:{}'.format(self.data_path))
        print('{PROJECT_ROOT}/datareader/meta_dataset_config.gin')
        if image_size==84:
            gin.parse_config_file(f'{PROJECT_ROOT}/datareader/meta_dataset_config.gin')
...
class SingleDatasetReader:
    ...
    """
    def __init__(self, data_path, mode, dataset, way, shot, query_train, query_test, image_size=84):
